...
#### Nmap
Con `nmap` si può sapere, quanti host, mac address, ip address della rete, costruttore di host, porte aperte, cosi si può profilare la macchina della vittima.

Al giorno di oggi `nmap` viene filtrato dal firewall.
